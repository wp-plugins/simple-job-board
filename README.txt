...
The plugin is available in English, French(Français), Arabic (العربية) and Brazilian Portuguese(Português do Brasil).
...
*  Use Anti-hotlinking option to enhance securtiy of your documents.
...
7. **General** - Let your users change view of job listing on front end.
...
13. **Modified Job Listing** - Modified Front end view of a job listing. 
14. **Modified Job details page** - Job board detail/single page. Job features and job application form is placed on it.
...
* Feature - Added Arabic Translation.

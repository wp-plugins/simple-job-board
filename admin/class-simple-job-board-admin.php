...
class Simple_Job_Board_Admin
{
    ...
    public function enqueue_styles ()
    {
        ...
        wp_enqueue_style ( $this->simple_job_board . '-jqueryui', 'http://ajax.googleapis.com/ajax/libs/jqueryui/1.8.2/themes/smoothness/jquery-ui.css', array (), $this->version, 'all' );
        wp_enqueue_style ( $this->simple_job_board . '-google-fonts', 'http://fonts.googleapis.com/css?family=Open+Sans', array (), $this->version, 'all' );
    ...
    public function enqueue_scripts ()
    {
         ...
         * class.
         */
        wp_enqueue_script ( $this->simple_job_board, plugin_dir_url ( __FILE__ ) . 'js/simple-job-board-admin.js', array ( 'jquery' , 'jquery-ui-sortable' ), $this->version, FALSE );
    }
